...
class AiogramBotService(BaseService):
    ...
    async def initialize(self) -> None:
        ...
        if self._initialized:
            bot_logger.debug("ℹ️ Aiogram Bot Service already initialized, skipping")
            return
        ...
        bot_logger.info("✅ Aiogram Bot Service initialized")
    ...
    async def set_commands(self, commands: list[dict[str, str]], scope: str | None = None) -> bool:
        ...
        try:
            ...
            bot_logger.info(f"✅ Commands set: {len(commands)} commands")
            return True

        except Exception as e:
            bot_logger.error(f"❌ Failed to set commands: {e}")
            return False
    ...
    async def get_chat_member_count(self, chat_id: int) -> int | None:
        ...
        try:
            ...
            bot_logger.error(f"❌ Failed to get chat member count for {chat_id}: {e}")
            return None
    ...
    async def get_chat_member(self, chat_id: int, user_id: int) -> dict[str, Any]:
        ...
        try:
            ...
            bot_logger.error(f"❌ Failed to get chat member: {e}")
            return {}
