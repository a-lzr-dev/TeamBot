...
class Settings(BaseSettings):
    ...
    DB_MAIN_URL: str = "sqlite+aiosqlite:///./messages.db"
    ...
    DB_AVANPOST_URL: str = "mssql+aioodbc://sa:password@localhost:1433/TeamBot?driver=ODBC+Driver+17+for+SQL+Server"
    ...
    # Каналы для уведомлений о логах ошибок
    ...
    # Каналы для уведомлений о заявках (переопределяет SUPPORT_CHAT_IDS)
    ...
    @field_validator("ADMIN_IDS", "SUPPORT_CHAT_IDS", "AUTOMATION_NOTIFICATION_CHAT_IDS", mode="before")
    @classmethod
