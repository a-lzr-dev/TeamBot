...
class TelethonChatService(BaseService):
    ...
    async def initialize(self) -> None:
        ...
        tg_logger.debug("✅ Telethon Chat Service initialized")
    ...
    async def get_chat_from_telegram(self, chat_id: int) -> dict[str, Any] | None:
        ...
        try:
            ...
            tg_logger.warning(f"⏳ Flood wait: {e.seconds}s")
            return None
        except Exception as e:
            tg_logger.error(f"❌ Failed to get chat {chat_id}: {e}")
            return None
    ...
    async def health_check(self) -> bool:
        ...
        try:
            ...
            tg_logger.error(f"❌ Health check failed: {e}")
            return False
